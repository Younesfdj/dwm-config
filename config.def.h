...
static const char *fonts[]          = { "JetBrains Mono:pixelsize=17","fontawesome:size=12" };
static const char dmenufont[]       = "JetBrains Mono:pixelsize=17";
...
/* tagging */
static const char *tags[] = { "󰨞", "󰈹", "", "", "󰛮", "󰊢", "󰙯","", "󰙎" };
